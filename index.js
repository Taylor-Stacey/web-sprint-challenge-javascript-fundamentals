...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// internal can be reached by the nestedfunction because they are on the same level of scope
...
// console.log(animalNames)
  ...
  */
  ...
  function lowerCaseNames(zooAnimals){
    return zooAnimals.map(obj => obj.animal_name.toLowerCase());
  }
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals){
      const filteredArr = zooAnimals.filter (obj => (obj.population < 5))
      return filteredArr
    };
  ...
  */
  ...
  function USApop(zooAnimals){
    const totalPop = zooAnimals.reduce((previous, current) =>{
